...
//	
//	public String getMasterIndexVersion(String json, String jsonLevel, String jsonField ){
//		
//		JSONObject jsonObject = new JSONObject(json);
//		String versionTimeStamp =  jsonObject.getJSONObject(jsonLevel).getString(jsonField);
//		
//		String version = timestamp2microsec(versionTimeStamp);
//		logger.debug("getMasterIndexVersion: " + version); 
//		return version;
